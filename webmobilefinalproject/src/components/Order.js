...
const Order = () => {
    ...
    return (
        <>
            ...
            {/* Access message if blocked */}
            {!hasAccess ? (
                <div className="text-center my-5">
                    <h4>Please scan the QR code or register to view available items.</h4>
                </div>
            ) : (
                <>
                    {/* Filtered Products */}
                    ...
                    <ReactPaginate
                        ...
                        nextLabel={'>'}
                        breakLabel={'...'}
                        pageCount={3} // Consider making this dynamic
